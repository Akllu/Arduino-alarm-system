...
#define summeri 8 //Määritellään pinnit summerille ja sensoreille
#define trigPin 9
#define echoPin 10
#define trigPin1 22 
#define echoPin1 23
...
boolean kysytaankoSalasanaa = false;  //Totuusarvo kysytäänkö salasanaa
boolean halyjenTila = false;  //Hälytyksen tilasta kertovat totuusarvot
